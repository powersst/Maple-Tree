...
namespace MaterialSkin.Controls
{
    public class MaterialForm : Form, IMaterialControl
    {
        ...
        private const int STATUS_BAR_HEIGHT = 35;
        private const int ACTION_BAR_HEIGHT = 55;
        ...
        {
            var g = e.Graphics;
            Color shadow = Color.FromArgb(50, 16, 16, 16);
            Rectangle shadowBounce = new Rectangle(actionBarBounds.X, actionBarBounds.Y - 5, Width, 1);
            ...
            for (int i = 0; i < 8; i++)
                ...
                {
                    g.DrawRectangle(pen, shadowBounce.X + i * 0,
                                       shadowBounce.Y + i, shadowBounce.Width, shadowBounce.Height);
                }
            ...
            using (var formButtonsPen = new Pen(Color.White, 2))
            {
                // Minimize button.
                if (showMin)
                {
            ...
            //Form title
            g.DrawString(Text, SkinManager.ROBOTO_MEDIUM_12, SkinManager.ColorScheme.TextBrush, new Rectangle(SkinManager.FORM_PADDING, -8, Width, ACTION_BAR_HEIGHT), new StringFormat { LineAlignment = StringAlignment.Center });
        }
    }
